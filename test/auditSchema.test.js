...
test("provider extraction schema accepts cited evidence without a recommendation", () => {
  const extraction = {
    hard_stops: [{ criterion: "Eligible legal structure", category: "legal_status", status: "pass", source_section: "Opportunity section 1", source_quote: "Eligible applicants are public charities", explanation: "The supplied status meets the rule." }],
    fit_gaps: [],
